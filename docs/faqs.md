...
<br/>
A4：竞赛评分系统采用Vitis HLS软件，如果使用Vivado HLS则可能无法通过竞赛评分系统的仿真，影响竞赛成绩。因此，您需要将Vivado HLS的pragma适当修改，具体修改方式请参考[**说明文档**](https://github.com/xupsh/CCC2021/tree/main/fft)。竞赛的硬件平台是Xilinx的U50开发板。
<br/>
<br/>
